...
<body bgcolor = "pink">
 <center>
		<h2><a href = "RegistrationForm.jsp">Create User</a></h2>
	</center>
	...
	<div align = "center">
		<table border = "1" cellpadding = "5" bgcolor = "Lightgreen">
			...
			<tr>
				...
				<td><a href = "UpdateUserForm1.jsp?uid =<c:out value ='${user.uid}'/>">Update</a></td>
				<td><a href = "DeleteUserServlets?uid =<c:out value ='${user.uid}'/>">Delete</a></td>
			</tr>
			</c:forEach>
		</table>
	</div>
